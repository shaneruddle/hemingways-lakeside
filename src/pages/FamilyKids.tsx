      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#c9a84c] text-xs tracking-[0.4em] uppercase mb-3">Everything Families Need</p>
            <h2 className="text-3xl sm:text-4xl font-bold">Built For A Family Day Out</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {pillars.map(({ icon: Icon, title, desc, href, cta }) => (
              <div key={title} className="bg-[#141414] border border-white/5 rounded-2xl p-8 hover:border-[#c9a84c]/20 transition-colors group">
      ...
      <section className="py-24 px-4 bg-[#0a0a0a]">
        <div className="max-w-4xl mx-auto bg-[#141414] border border-white/10 rounded-3xl p-10 sm:p-14">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-bold">What A Family Day Here Looks Like</h2>
          </div>
      ...
      <section className="py-24 px-4 bg-[#0a0a0a]">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm">Walk-ins always welcome &mdash; let us know ahead for bigger groups or a birthday</p>
          </div>
          <EnquiryForm
            type="general"
